...
- **Local LIBERO branch:** See [LIBERO preprocessing changes](docs/LIBERO_PREPROCESSING_README.md) for the two-view image layout, LIBERO prompt path, action/state projector ids, and gripper conversion used by this branch.
